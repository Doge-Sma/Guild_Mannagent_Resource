...
public class AdministradorController {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> removerAdministrador(@PathVariable Long id){
    ...
    public ResponseEntity<Void> removerGuildaDeAdministrador(@PathVariable Long id_Administrador, Long id_Guilda){
